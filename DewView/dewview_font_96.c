 ...
 * Size: 96 px
 * Bpp: 4
 * Opts: --font /home/user/DewView/ESP32-S3-Touch-LCD-5-Demo/Arduino/libraries/lvgl/scripts/built_in_font/Montserrat-Medium.ttf --size 96 --bpp 4 --format lvgl --no-compress -o dewview_font_96.c --range 0x20,0x25,0x2D,0x2E,0x30-0x39,0xB0 --symbols C
 ******************************************************************************/

#include <lvgl.h>

#ifndef DEWVIEW_FONT_96
#define DEWVIEW_FONT_96 1
#endif
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xca, 0x98, 0x88, 0x9a, 0xce, 0xff, 0xff, 0xff,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 2588, .adv_w = 588, .box_w = 27, .box_h = 8, .ofs_x = 5, .ofs_y = 22},
    {.bitmap_index = 2696, .adv_w = 349, .box_w = 14, .box_h = 14, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 2794, .adv_w = 1025, .box_w = 56, .box_h = 69, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 4726, .adv_w = 568, .box_w = 26, .box_h = 67, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 5597, .adv_w = 882, .box_w = 51, .box_h = 68, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 7331, .adv_w = 879, .box_w = 51, .box_h = 68, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 9065, .adv_w = 1028, .box_w = 61, .box_h = 67, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 11109, .adv_w = 882, .box_w = 51, .box_h = 68, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 12843, .adv_w = 948, .box_w = 53, .box_h = 69, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 14672, .adv_w = 919, .box_w = 52, .box_h = 67, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 16414, .adv_w = 989, .box_w = 54, .box_h = 69, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 18277, .adv_w = 948, .box_w = 53, .box_h = 69, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 20106, .adv_w = 1111, .box_w = 62, .box_h = 69, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 22245, .adv_w = 644, .box_w = 32, .box_h = 31, .ofs_x = 4, .ofs_y = 36}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t dewview_font_96 = {
#else
lv_font_t dewview_font_96 = {
#endif
